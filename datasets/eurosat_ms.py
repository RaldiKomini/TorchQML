...
def data_to_flat(root, used, ntr= 1000, nval = 300, nte = 300):
    train_s, val_s, test_s = pickdata(root, used, ntr, nval, nte)
...
def flat_to_pca(train_set, val_set, test_set, n_comp = 32, save_dir = None):
...
def data_to_pca(root, used, ntr=1000, nval=300, nte=300, ncomp=64, save_dir = None):
    train_set, val_set, test_set = data_to_flat(root, used, ntr=ntr, nval=nval, nte=nte)
    tr, va, te = flat_to_pca(train_set, val_set, test_set, n_comp=ncomp, save_dir=save_dir)
    return tr, va, te
