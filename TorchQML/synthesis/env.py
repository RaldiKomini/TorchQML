...
class CircuitSynthesisEnv(gym.Env):
    ...
    def __init__(
        ...
        self.previous_fidelity = unitary_fidelity(self.simulator.unitary, self.target)
    ...
    def reset(self, seed=None, options=None):
        ...
        info = {
            "fidelity": self.previous_fidelity,
            "best_fidelity": self.best_fidelity,
            "distance": unitary_distance(self.simulator.unitary, self.target),
    ...
    def step(self, action_idx):
        ...
        if blocked or too_deep:
            ...
            # Penalties are based on primitive gates, even for macro actions.
            apply_action(self.simulator, action)
            new_fidelity = unitary_fidelity(self.simulator.unitary, self.target)
